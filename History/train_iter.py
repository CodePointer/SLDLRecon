...
from Module.generator_net_grid import GeneratorNet
...
def train_iteration(root_path, lr_n, start_epoch=1):
    ...
    gkernel = torch.from_numpy(gkern(13, nsig=3)).unsqueeze(0).unsqueeze(1)  # [1, 1, Hk, Wk]
